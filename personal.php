  ...
  <div class="employees">
      <div class="container">
       ...
       <div class="vmist">
        ...
        <?php
              $department = mysqli_query($connect, "SELECT `name`,`job_title`,`name_depart`, `phone` FROM `registr_kor` WHERE `name_depart`= (SELECT `name_depart` FROM `registr_kor` WHERE `Id_K`= '$idd')");
